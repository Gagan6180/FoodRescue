...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0f172a] text-[#94a3b8] mt-auto border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-12">
          {/* Brand Col */}
          <div className="md:col-span-2 space-y-4">
            <Link to="/" className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-full bg-slate-800 border border-slate-700 text-white flex items-center justify-center shadow-xs">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-300 bg-slate-800/60 p-3 rounded-xl border border-slate-700/60 max-w-sm">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-slate-400">
              <li>
                <Link to="/register-volunteer" className="hover:text-white transition-colors text-emerald-400 font-medium">
              ...
              <li>
                <button
                  ...
                  className="text-xs text-slate-400 hover:text-white underline underline-offset-2 transition-colors mt-2 block"
                >
                  Reset Demo Data
                </button>
              </li>
        ...
        <div className="mt-12 pt-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400 gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <span className="text-slate-300">Food Safety Standards</span>
          </div>
        </div>
      </div>
    </footer>
